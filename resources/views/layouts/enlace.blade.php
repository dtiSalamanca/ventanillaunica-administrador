...
<head>
    ...
    <title>Ventanilla Única | Enlace | Salamanca, Guanajuato</title>
    <script>
        (function() {
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-header">
                    <h1>Panel de Enlace — Ventanilla Única</h1>
                </div>
                ...
                <div class="sb-sidenav-menu">
                    ...
                    <div class="nav">
                        <!-- Inicio -->
                        <a class="nav-link active {{ request()->routeIs('enlace.home') ? 'active-current' : '' }}"
                            href="{{ route('enlace.home') }}">
                        ...
                        <a class="nav-link active {{ request()->routeIs('enlace.tramitesTurnados') ? 'active-current' : '' }}"
                            href="{{ route('enlace.tramitesTurnados') }}">
