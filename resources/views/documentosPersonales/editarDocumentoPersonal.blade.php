...
@section('content')
    <link rel="stylesheet" href="{{ asset('css/documentosPersonales/editarDocumentoPersonal.css') }}">
    ...
    <div class="main-container">
        <div class="page-header">
            <div class="header-content">
                ...
                <div class="header-main">
                    <h1 class="page-title">Editar documento personal</h1>
                    <p class="page-subtitle">Modifica los datos del documento personal seleccionado.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('actualizarDocumentoPersonal', $documentoPersonal) }}" id="form-editar-documento-personal" novalidate>
                    @csrf
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre_documento" id="nombre_documento"
                                ...
                                value="{{ old('nombre_documento', $documentoPersonal->nombre_documento) }}" maxlength="255" required
                        ...
                        <div class="form-group">
                            <label for="descripcion" class="form-label">
                                <i class="fas fa-align-left me-1"></i>Descripción del documento
                            </label>
                            <textarea name="descripcion" id="descripcion" rows="4"
                                class="form-control @error('descripcion') is-invalid @enderror"
                                required autocomplete="off"
                                placeholder="Describe brevemente en qué consiste el documento">{{ old('descripcion', $documentoPersonal->descripcion_documento) }}</textarea>
                            <div class="field-footer">
                                <span class="field-message">
                                    @if ($errors->has('descripcion'))
                                        <span class="field-error"><i class="fas fa-circle-exclamation me-1"></i>{{ $errors->first('descripcion') }}</span>
                                    @else
                                        <span class="field-hint">Explica brevemente el propósito del documento</span>
                                    @endif
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="vigencia_meses" id="vigencia_meses"
                                ...
                                value="{{ old('vigencia_meses', $documentoPersonal->vigencia_meses) }}" min="1" required
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-accion btn-guardar" id="btn-actualizar-documento-personal">
                            <i class="fas fa-floppy-disk"></i>Actualizar documento personal
                        </button>
                    </div>
                </form>
            </div>
...
@section('scripts')
    <script src="{{ asset('js/documentosPersonales/editarDocumentoPersonal.js') }}"></script>
@endsection
