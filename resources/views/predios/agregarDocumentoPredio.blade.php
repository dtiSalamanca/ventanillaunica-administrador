...
@section('content')
    <link rel="stylesheet" href="{{ asset('css/predios/agregarDocumentoPredio.css') }}">
    ...
    <div class="main-container">
        <div class="page-header">
            <div class="header-content">
                ...
                <div class="header-main">
                    <h1 class="page-title">Agregar documento de predio</h1>
                    <p class="page-subtitle">Registra un nuevo documento de predio con su nombre.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('registrarDocumentoPredio') }}" id="form-agregar-documento-predio" novalidate>
                    @csrf
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-accion btn-guardar" id="btn-guardar-documento-predio">
                            <i class="fas fa-floppy-disk"></i>Guardar documento de predio
                        </button>
                    </div>
                </form>
            </div>
...
@section('scripts')
    <script src="{{ asset('js/predios/agregarDocumentoPredio.js') }}"></script>
@endsection