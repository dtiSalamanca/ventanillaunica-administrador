                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="background-color:#601028; padding:28px 32px; text-align:center;">
                            ...
                            <p style="margin:6px 0 0; color:rgba(255,255,255,0.9); font-size:13px;">Ayuntamiento de
                                Salamanca</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:32px;">
                            @if ($aprobado)
                                <div
                                    style="display:inline-block; background-color:#e6f9f1; color:#10b981; font-weight:700; font-size:13px; padding:6px 14px; border-radius:999px; margin-bottom:16px;">
                                    Predio aprobado
                                </div>
                                <p style="font-size:15px; line-height:1.6; margin:0 0 12px;">Hola {{ $nombreUsuario }},
                                </p>
                                <p style="font-size:15px; line-height:1.6; margin:0 0 12px;">
                                    Tu predio con cuenta predial <strong>{{ $clavePredio }}</strong> ha sido
                            ...
                            @else
                                ...
                                @if (!empty($motivoRechazo))
                                    <p
                                        style="font-size:14px; line-height:1.6; margin:0 0 12px; background-color:#fdeceb; color:#b91c1c; padding:10px 14px; border-radius:8px;">
                                        <strong>Motivo del rechazo:</strong><br>
                                        {{ $motivoRechazo }}
                                    </p>
                                @endif
                                <p style="font-size:15px; line-height:1.6; margin:0 0 20px;">
                                    Ingresa a tu perfil para corregir la cuenta predial y enviarlo nuevamente a
                                    revisión.
                                </p>
                                <div style="text-align:center;">
                                    <a href="{{ $urlPerfil }}"
                                        style="display:inline-block; background-color:#601028; color:#ffffff; text-decoration:none; font-weight:600; font-size:14px; padding:12px 24px; border-radius:8px;">
                                        Ir a mi perfil
                                    </a>
                                </div>
                            @endif
