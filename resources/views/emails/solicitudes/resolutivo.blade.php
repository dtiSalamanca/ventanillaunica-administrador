...
<head>
    ...
    <title>Tu trámite ha concluido - Ventanilla Única</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:15px; line-height:1.6; margin:0 0 12px;">
                                <strong>Tu trámite ya tiene una respuesta.</strong>
                            </p>
                            <p style="font-size:15px; line-height:1.6; margin:0 0 20px;">
                                Para consultar tu resolutivo, realiza el pago correspondiente en caja. Después, ingresa
                                al portal para consultarlo y descargarlo.
                            </p>
