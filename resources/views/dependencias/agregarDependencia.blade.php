...
@section('content')
    <link rel="stylesheet" href="{{ asset('css/dependencias/agregarDependencia.css') }}">
    ...
    <div class="main-container">
        <div class="page-header">
            <div class="header-content">
                ...
                <div class="header-main">
                    <h1 class="page-title">Agregar dependencia</h1>
                    <p class="page-subtitle">Registra una nueva dependencia con su nombre.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('registrarDependencia') }}" id="form-agregar-dependencia" novalidate>
                    @csrf
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-accion btn-guardar" id="btn-guardar-dependencia">
                            <i class="fas fa-floppy-disk"></i>Guardar dependencia
                        </button>
                    </div>
                </form>
            </div>
...
@section('scripts')
    <script src="{{ asset('js/dependencias/agregarDependencia.js') }}"></script>
@endsection
